...
<article class="prose prose-sm mx-auto max-w-3xl dark:prose-invert">
	...
	<section>
		<h2>7. Booking Process and Payment Terms</h2>

		<h3>7.1 Booking Requests</h3>
		<p>
	...
	<section>
		...
		<h3>13.4 Arbitration</h3>
		<p>
			Any dispute arising from these Terms or the Platform that cannot be resolved informally
			shall be resolved through binding arbitration in accordance with the rules of [Arbitration
			Body], except where prohibited by law.
		</p>
	</section>
