	...
	<!-- Role Selection Screen -->
			...
			<div class="space-y-4">
                <div class="flex flex-col gap-2 items-center justify-center">
                    <a href={route('/dashboard/choose-role/default-user')} class=" w-full {buttonVariants({ variant: "default" })}" >{m.role_student()}</a>
                    <a href={route('/dashboard/choose-role/instructor')} class="w-full {buttonVariants({ variant: "default" })}">{m.role_instructor()}</a>
