...
<!-- Beta Launch Banner -->
<section class="bg-green-50 border-y-2 border-green-500 py-8 dark:bg-green-950">
	<div class="container">
		<div class="mx-auto max-w-3xl text-center">
			<div class="mb-4 inline-flex items-center gap-2 rounded-full bg-green-100 px-4 py-2 text-sm font-semibold text-green-900 dark:bg-green-900 dark:text-green-100">
			...
			<h2 class="mb-3 text-2xl font-bold text-green-900 md:text-3xl dark:text-green-100">
				{m.beta_launch_title()}
			</h2>

			<p class="mb-4 text-lg text-green-800 dark:text-green-200">
				{m.beta_launch_description()}
			</p>

			<div class="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
				<div class="flex items-center gap-2 rounded-lg bg-white border-2 border-green-200 px-4 py-3 dark:bg-green-900/50 dark:border-green-700">
					...
					<span class="text-sm text-green-900 dark:text-green-100">{m.beta_launch_valid_until()}</span>
				</div>
				<div class="flex items-center gap-2 rounded-lg bg-white border-2 border-green-200 px-4 py-3 dark:bg-green-900/50 dark:border-green-700">
					...
					<span class="text-sm text-green-900 dark:text-green-100">{m.beta_launch_no_fees()}</span>
				</div>
			</div>
		</div>
	</div>
